...
(yas-define-snippets 'java-mode
		     '(("h" "public class ${1:`(file-name-sans-extension (buffer-name))`} {\n    public static void main(String[] args) {\n        System.out.println(\"Hello world!\");\n    }\n}\n" "Hello World" nil nil nil nil nil nil)
		       ...
		       ("pa" "package ${1:`(mapconcat 'identity (split-string (replace-regexp-in-string \".*src/\\\\(main\\\\|test\\\\)?\\\\(/java\\\\)?\" \"\" default-directory) \"/\" t) \".\")`};$0" "package" nil nil nil nil nil nil)
		       ...
		       ("ret" "return $1;$0" "return" nil nil nil nil nil nil)
